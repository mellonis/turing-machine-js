...
export { default as State, CallFrame, DebugConfig, haltState, abortState, ifOtherSymbol, type HaltState, type AbortState } from './classes/State';
...
export { default as TuringMachine, type MachineState, type PauseInfo, type PausedMachineState, type RunResult } from './classes/TuringMachine';
export {
