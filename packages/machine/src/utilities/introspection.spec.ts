...
describe('summarizeGraph', () => {
  test('counts states and transitions', () => {
    const graph: Graph = {
      ...
      nodes: {
        ...
        1: {
          id: 1, name: 'a', isHalt: false, isAbort: false, overriddenHaltStateId: null, isHaltMarker: false, isWrapper: false, bareStateId: null, frameId: null, tags: [],
          transitions: [
  ...
  test('computes max composition depth', () => {
    ...
    const graph: Graph = {
      ...
      nodes: {
        0: {id: 0, name: 'halt', isHalt: true, isAbort: false, transitions: [], overriddenHaltStateId: null, isHaltMarker: false, isWrapper: false, bareStateId: null, frameId: null, tags: []},
        1: {id: 1, name: 'a', isHalt: false, isAbort: false, transitions: [], overriddenHaltStateId: 2, isHaltMarker: false, isWrapper: false, bareStateId: null, frameId: null, tags: []},
        2: {id: 2, name: 'b', isHalt: false, isAbort: false, transitions: [], overriddenHaltStateId: 3, isHaltMarker: false, isWrapper: false, bareStateId: null, frameId: null, tags: []},
        3: {id: 3, name: 'c', isHalt: false, isAbort: false, transitions: [], overriddenHaltStateId: null, isHaltMarker: false, isWrapper: false, bareStateId: null, frameId: null, tags: []},
      },
    };
  ...
  test('returns zero composition depth when no overrides', () => {
    const graph: Graph = {
      ...
      nodes: {
        0: {id: 0, name: 'halt', isHalt: true, isAbort: false, transitions: [], overriddenHaltStateId: null, isHaltMarker: false, isWrapper: false, bareStateId: null, frameId: null, tags: []},
        1: {id: 1, name: 'a', isHalt: false, isAbort: false, transitions: [], overriddenHaltStateId: null, isHaltMarker: false, isWrapper: false, bareStateId: null, frameId: null, tags: []},
      },
    };
...
describe('summarizeGraph defensive guards', () => {
  ...
  test('terminates on a cyclic override chain instead of recursing forever', () => {
    const graph: Graph = {
      ...
      nodes: {
        1: {id: 1, name: 'a', isHalt: false, isAbort: false, transitions: [], overriddenHaltStateId: 2, isHaltMarker: false, isWrapper: false, bareStateId: null, frameId: null, tags: []},
        2: {id: 2, name: 'b', isHalt: false, isAbort: false, transitions: [], overriddenHaltStateId: 1, isHaltMarker: false, isWrapper: false, bareStateId: null, frameId: null, tags: []},
      },
    };
